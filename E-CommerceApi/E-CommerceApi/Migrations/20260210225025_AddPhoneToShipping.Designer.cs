...
namespace E_CommerceApi.Migrations
{
    ...
    [Migration("20260210225025_AddPhoneToShipping")]
    partial class AddPhoneToShipping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_CommerceApi.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_CommerceApi.Models.Shipping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_CommerceApi.Models.OrderItem", b =>
                {
                    b.HasOne("E_CommerceApi.Models.Item", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("E_CommerceApi.Models.Payment", b =>
                {
                    b.HasOne("E_CommerceApi.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("E_CommerceApi.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("E_CommerceApi.Models.Shipping", b =>
                {
                    b.HasOne("E_CommerceApi.Models.ApplicationUser", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId");

                    b.HasOne("E_CommerceApi.Models.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("E_CommerceApi.Models.Shipping", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
